...
3. **Virtualization** — cloud takes the hardware away; this is what you get instead, and how to choose it.
   → [1.2_Components_of_the_Cloud_Stack.md](1.2_Components_of_the_Cloud_Stack.md)
4. **Images and containers** — how the app gets packaged, built, and isolated on that.
   → [1.3_Components_of_the_Cloud_Stack.md](1.3_Components_of_the_Cloud_Stack.md)
5. **Networking** — compute is ephemeral, so nothing has a fixed address; traffic replaces location.
   → [1.2_Components_of_the_Cloud_Stack.md](1.2_Components_of_the_Cloud_Stack.md#why-is-cloud-compute-ephemeral)
