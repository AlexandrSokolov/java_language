...
- [**Lost parallelism.**](#how-does-a-lock-affect-parallelism) 
  While one thread holds the lock, every other thread that wants it sits idle. 
...
### How does a lock affect parallelism?
<details><summary>Show answer</summary>
