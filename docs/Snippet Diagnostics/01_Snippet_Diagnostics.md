...
[It is not possible to extend a **concrete, instantiable class** and **add a new value component**](../FAQs/03_Commmon_methods/3.1_methods_common_to_all_objects.md#what-should-you-consider-regarding-the-equality-contract-when-creating-subclasses)
while fully preserving all requirements of the equals contract (in particular, symmetry and transitivity).


In such cases, you should [favor composition over inheritance](../FAQs/03_Commmon_methods/3.1_methods_common_to_all_objects.md#how-should-valuesubclass-equality-problems-be-handled).
