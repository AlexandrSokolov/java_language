...
- Avoid unnecessary object creation (avoid autoboxing, string instances, etc.)
- Control how and when instances are created
- Reuse or cache when beneficial:
  - immutable objects
  - shared mutable instances where appropriate
- Use instance‑controlled classes:
  - singletons
  - enums
- Prevent instantiation when appropriate (final utility class)
