...
[The free combination across every branch](../FAQs/04_Classes_&_Interfaces/3.4_classes_and_interfaces.md#how-does-subclassing-explode-on-varying-state)
...
[→ parent or branch?](../FAQs/04_Classes_&_Interfaces/3.4_classes_and_interfaces.md#what-decides-whether-a-property-belongs-to-the-parent-or-a-branch)
...
- Read by others for ordering → Case A. 
  [→ when is strategy the right tool?](../FAQs/04_Classes_&_Interfaces/3.4_classes_and_interfaces.md#when-is-strategy-the-right-tool) 
...
[→ what rules out subclassing](../FAQs/04_Classes_&_Interfaces/3.4_classes_and_interfaces.md#what-rules-out-subclassing-as-a-modeling-tool)
...
once → decorator.**
[→ when is decorator the right tool?](../FAQs/04_Classes_&_Interfaces/3.4_classes_and_interfaces.md#when-is-decorator-the-right-tool)
[→ strategy or decorator — which fits?](../FAQs/04_Classes_&_Interfaces/3.4_classes_and_interfaces.md#strategy-or-decorator--which-fits)
